...
{\sloppy
\parit{Next we show that the  measure $\Lap\phi_t$ is absolutely continuous on $e_t\Gamma$ and that \hbox{$r_t(\gamma(t))=\rho_t(\gamma(t)){\cdot}\Lap\phi_t$} in some weak sense.}
